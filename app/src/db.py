    ...
    if(engine.connect()):
        ...
        try:
            ...
            if subset is None:
                ...
                cleaned[subset].reset_index(drop=True, inplace=True)
                cleaned[subset].to_sql(tablename, con=engine, if_exists=('replace' if not append else 'append'), index=False)
